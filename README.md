...
Profissional em formação, com foco em computação, banco de dados, matemática aplicada e análise de dados. Experiência em projetos práticos voltados à construção de soluções limpas, estruturadas e funcionais.
